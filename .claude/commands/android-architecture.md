...
See [structure & examples](android-architecture/references/implementation.md) for Clean Architecture layer examples.
...
See [structure & examples](android-architecture/references/implementation.md) for module configuration.
...
- [Structure & Examples](android-architecture/references/implementation.md)
- [Jetpack Compose Best Practices](android-architecture/references/compose-standards.md)
