...
See [setup & wrappers](android-networking/references/implementation.md) for DTO and API examples.
...
See [setup & wrappers](android-networking/references/implementation.md) for API endpoint definitions.
...
- [Setup & Wrappers](android-networking/references/implementation.md)
