...
See [templates](android-state/references/implementation.md) for ViewModel and UiState examples.
...
See [templates](android-state/references/implementation.md) for sealed UiState pattern.
...
- [Templates](android-state/references/implementation.md)
