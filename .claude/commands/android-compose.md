...
See [implementation examples](android-compose/references/implementation.md) for state hoisting patterns.
...
See [implementation examples](android-compose/references/implementation.md) for `derivedStateOf` usage.
...
- [Optimization Patterns](android-compose/references/implementation.md)
