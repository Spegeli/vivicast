...
For more information on interacting with running devices, see [here](android-cli/references/interact.md)

## Running journey tests
For more information on running journeys, see [here](android-cli/references/journeys.md)
