...
> [!IMPORTANT]
> **Important:** Always consult the documentation of the applicable framework to learn about testing (for example: [Hilt testing guide](testing-setup/references/android/training/dependency-injection/hilt-testing.md), [Koin Instrumented tests](https://insert-koin.io/docs/reference/koin-android/instrumented-testing)).
...
- Compose Preview Screenshot Testing tool for screenshot tests - check [setup
  documentation](testing-setup/references/android/studio/preview/compose-screenshot-testing.md) and follow it strictly.
...
common patterns](testing-setup/references/android/develop/ui/compose/testing/common-patterns.md)" to simulate different window sizes, font scales
...
- Ask whether to document the findings of the analysis and the changes applied
  ...
  - If there is a CLAUDE.md file present in the project, update it with any
    changes you've made to the testing strategy.

  - If there is no CLAUDE.md file, create a new file (docs/testing.md) with
    ...
    Also create a new CLAUDE.md file in the root and create a link to
    docs/testing.md.
