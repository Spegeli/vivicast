...
See [migration guide](android-agp-upgrade/references/built-in-kotlin.md) for detailed steps.
...
See [DSL migration](android-agp-upgrade/references/dsl-migration.md) for before/after examples.
...
- [Built-in Kotlin Migration](android-agp-upgrade/references/built-in-kotlin.md)
- [DSL Migration Guide](android-agp-upgrade/references/dsl-migration.md)
