 ...
 * sources list, the EPG-area provider list and the provider↔EPG-source links (P1-04f3a) are
 * collected from the repositories in the ViewModel. Manual EPG mapping, Provider settings,
 * Backup, Parental and About stay App-hoisted for now.
 */
