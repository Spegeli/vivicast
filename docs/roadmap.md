...
- Worker contains job-name constants, concrete WorkManager refresh wrappers, request scheduling, a testable refresh orchestrator, and diagnostics redaction foundation.
